import numpy, random
from GL_Deep_RL import optimization
...
def func(Transport_Capacity,Retailers,Time,n_V,TransportationCost,bs,x_value,y_value,TranshipmentCost,TotalCost,n_r,i,col_n):
    ...
    round_TranshipCost,round_TotalCost,round_TransportCost=optimization.algm(InventaryholdingCost,Lostscale,TranshipmentCost,TransportationCost, n_V, n_r,opt_nodes,Retailers,Transport_Capacity,Time)

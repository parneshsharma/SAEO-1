import numpy, random
from Integrated_location_Inventory_routing import optimization
...
def func(Transport_Capacity,Retailers,Time,n_V,TransportationCost,bs,x_value,y_value,TranshipmentCost,TotalCost,n_r,i,col_n):
    ...
    Retailer,round_TranshipCost,round_TotalCost,round_TransportCost=optimization.algm(InventaryholdingCost,Lostscale,TranshipmentCost,TransportationCost, n_V, n_r,opt_nodes,Retailers,Transport_Capacity,Time)
